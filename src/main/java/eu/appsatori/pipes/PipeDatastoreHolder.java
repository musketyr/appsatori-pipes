...
public class PipeDatastoreHolder {
	
	private static PipeDatastore pipeDatastore = new DatastorePipeDatastore();
	
	private PipeDatastoreHolder() {}
	...
	public static void setPipeDatastore(PipeDatastore pipeDatastore) {
		PipeDatastoreHolder.pipeDatastore = pipeDatastore;
	}
