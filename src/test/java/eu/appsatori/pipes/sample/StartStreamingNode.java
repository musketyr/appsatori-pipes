...
import eu.appsatori.pipes.StreamingPipe;

public class StartStreamingNode implements Node<StreamingPipe, Object> {
	
	private static final Logger log = Logger.getLogger(StartStreamingNode.class.getName());
	
	public NodeResult execute(StreamingPipe pipe, Object arg) {
		log.info("Starting streaming");
		for(String s: new String[]{"Hello", "World", "of", "AppSatori", "Pipes"}){
